...
<html>
      ...
      <body>
            ...
            <p>
                  These terms and conditions outline the rules and regulations for the use of SEO's Website.
            </p> 
            
            <br /> 
            
            <span style="text-transform: capitalize;"> SEO </span> is located at:
            
            <br /> 
            
            <address>
                  Street Suburb, Esbjerg<br />Region - Zip, Country<br />
            </address>
      
            <p>
                  By accessing this website we assume you accept these terms and conditions in full. Do not continue to use SEO's website 
            ...
            <p>
                  ...
                  of Country. Any use of the above terminology or other words in the singular, plural,
            ...
            <p>
                  We employ the use of cookies. By using SEO's website you consent to the use of cookies 
                  in accordance with SEO’s privacy policy.
            </p>
            <p>
            ...
            <p>
                  Unless otherwise stated, SEO and/or it’s licensors own the intellectual property rights for
                  all material on SEO. All intellectual property rights are reserved. You may view and/or print
                  pages from https://seo.designermadsen.com for your own personal use subject to restrictions set in these terms and conditions.
            </p>
            <p>
                  You must not:
            </p>
            <ol>
                  <li>
                        Republish material from https://seo.designermadsen.com
                  </li>
                  <li>
                        Sell, rent or sub-license material from https://seo.designermadsen.com
                  </li>
                  <li>
                        Reproduce, duplicate or copy material from https://seo.designermadsen.com
                  </li>
            </ol>
            <p>
                  Redistribute content from SEO (unless content is specifically made for redistribution).
            </p>
      ...
      <p>
            ...
            <a href="mailto:kent.vejrup.madsen@outlook.com" 
               title="send an email to kent.vejrup.madsen@outlook.com">
      ...
      <p>
            No use of SEO’s logo or other artwork will be allowed for linking absent a trademark license
            agreement.
      </p>
      ...
      <h2>
            ...
            <p>
                  ...
                  <a style="color:inherit;text-decoration:none;cursor:text;"
